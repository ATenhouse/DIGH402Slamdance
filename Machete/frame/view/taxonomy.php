...
class TaxonomyViewer extends BuildHTML {
	...
	$headers = array("title","description","text","image","map coords","text link", "image link", "map link");
	...
	self::$taxa_content .= $item_row_start.$item_title_cell.$item_desc_cell.$item_text_cell.$item_img_cell.$map_cell.$text_link_cell.$img_link_cell.$map_link_cell.$row_end;
	}
